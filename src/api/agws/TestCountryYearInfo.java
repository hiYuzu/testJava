 ...
 * @author yuzu
 * @version v1.0
 * @since 2023/9/4 11:30
 */
public class TestCountryYearInfo {
    ...
    private static final String SYS_METHOD = "/openApi/yearInfo/country";
    ...
    public static void main(String[] args) throws Exception {
        // JSON字符串格式
        String content = JSONUtil.toJsonStr(CountryYearInfoEntity.getOne());
        // SM2加密
     ...
     * 城市年度信息所有字段
     */
    public static class CountryYearInfoEntity {
        /**
         * 行政区划编码（9位码，补0），必填
         */
        ...
        public static CountryYearInfoEntity getOne() {
            return new CountryYearInfoEntity();
        }
    }
}
